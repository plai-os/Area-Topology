const CARD_VERSION = "1.25.12";
const BUILD_COMMIT = "b5e5c02";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge-shell>aside b:first-child::before { content:""; position:absolute; top:0; left:100%; width:28px; height:36px; border-radius:0 0 36px 0; background:var(--bridge-tone); }
