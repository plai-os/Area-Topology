...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    @font-face { font-family:"LCARS GTJ3"; src:url("${CARD_BASE_URL}fonts/LCARSGTJ3.woff2") format("woff2"),url("${CARD_BASE_URL}fonts/LCARSGTJ3.woff") format("woff"),url("${CARD_BASE_URL}fonts/LCARSGTJ3.ttf") format("truetype"); font-style:normal; font-weight:400; font-display:swap; }
