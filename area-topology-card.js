const CARD_VERSION = "1.27.62";
const BUILD_COMMIT = "9906dc0";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-status-ribbon { position:absolute; z-index:8; bottom:-23px; left:75%; display:grid; grid-template-columns:minmax(145px,1fr) minmax(155px,1fr) minmax(145px,1fr); width:min(520px,42vw); height:46px; padding:5px; border-radius:25px; background:#050507; transform:translateX(-50%); pointer-events:none; }
