const CARD_VERSION = "1.25.14";
const BUILD_COMMIT = "86ef83d";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge-shell>aside b:first-child::before { content:""; position:absolute; top:0; left:100%; width:28px; height:36px; background:radial-gradient(circle 36px at 100% 100%,#050507 0 35px,var(--bridge-tone) 36px); }
