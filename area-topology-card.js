...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-meter,.lcars-meter span,.lcars-standby { font-size:20px!important; }.lcars-meter b { font-size:21px!important; }.lcars-area-reading b { font-size:18px!important; }.lcars-bridge-camera>footer span,.lcars-bridge-camera>footer b { font-size:21px!important; }.tree-property b,.tree-property em { font-size:calc(var(--tree-property,12px) * 1.3)!important; }.lcars-bridge .lcars-meter,.lcars-bridge .lcars-meter span,.lcars-bridge .lcars-standby { font-size:22px!important; }.lcars-bridge .lcars-meter b { font-size:23px!important; }
