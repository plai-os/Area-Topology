...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:1000px) { .lcars-bridge-grid { grid-template-columns:1fr; }.lcars-bridge-grid::before,.lcars-bridge-grid::after,.lcars-bridge-primary::after,.lcars-bridge-secondary::before { display:none; }.lcars-bridge>header { flex-wrap:wrap; padding:12px 18px; }.lcars-bridge>header i { display:none; }.lcars-bridge-camera>footer { grid-template-columns:repeat(2,1fr); } }
