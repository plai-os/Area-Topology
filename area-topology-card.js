const CARD_VERSION = "1.25.21";
const BUILD_COMMIT = "ec91871";
...
class AreaTopologyCard extends HTMLElement {
  ...
  renderLcars() {
    ...
    const navigationFloorViews = floorViews
      .filter((group) => !matchedBridgeFloor || group.id !== matchedBridgeFloor.id)
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-floor-nav button span { justify-content:center; padding-top:2px; border-radius:28px 0 0 28px; font-family:var(--lcars-font); font-size:31px; font-weight:400; letter-spacing:.015em; line-height:1; text-indent:2px; }
