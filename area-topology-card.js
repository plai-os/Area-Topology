...
class AreaTopologyCard extends HTMLElement {
  ...
  renderLcarsUnifiedCommand(view, inner, status = "SYSTEMS") {
    ...
    const railTop = rail.top || view.rail_top || "MJ-32";
    const railMiddle = rail.middle || view.rail_middle || "DATA MODE";
    const railBottom = rail.bottom || view.rail_bottom || railTop;
  ...
  renderLcarsBridge(config, group, securityConfig, color) {
    ...
    const railTop = rail.top || config.rail_top || "MJ-32";
    const railMiddle = rail.middle || config.rail_middle || "DATA MODE";
    const railBottom = rail.bottom || config.rail_bottom || railTop;
