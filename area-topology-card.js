...
class AreaTopologyCard extends HTMLElement {
  ...
  styleLcarsCalendar(card, color) {
    ...
    const css = `
      ...
      .fc .fc-toolbar-title { color:#f5f1ff; font-family:var(--lcars-font)!important; font-size:30px!important; font-weight:400!important; letter-spacing:.045em; text-transform:uppercase; }
      ...
      .fc .fc-button,.fc .fc-button-primary,.fc .fc-today-button,button,mwc-button,ha-button { min-height:38px; border:0!important; border-radius:20px!important; color:${contrast}!important; background:${color}!important; box-shadow:none!important; font-family:var(--lcars-font)!important; font-size:15px!important; font-weight:400!important; letter-spacing:.05em!important; text-transform:uppercase; }
      ...
      .fc .fc-col-header-cell-cushion { padding:9px 6px!important; color:${contrast}!important; font-family:var(--lcars-font)!important; font-size:15px; font-weight:400; letter-spacing:.05em; text-transform:uppercase; }
      .fc .fc-daygrid-day-number,.fc .fc-list-day-text,.fc .fc-list-day-side-text,.fc .fc-timegrid-slot-label { color:#f5f1ff!important; font-family:var(--lcars-font)!important; font-size:15px; letter-spacing:.035em; }
      ...
      .fc .fc-event { padding:4px 8px!important; border:0!important; border-radius:14px!important; font-family:var(--lcars-font)!important; font-size:14px!important; font-weight:400!important; letter-spacing:.025em; }
      ...
      .fc .fc-daygrid-more-link { color:${color}!important; font-family:var(--lcars-font)!important; font-size:14px; letter-spacing:.03em; text-transform:uppercase; }
  ...
  styles() { return `
    @font-face { font-family:"Antonio LCARS"; src:url("${CARD_BASE_URL}fonts/antonio-400.ttf") format("truetype"); font-style:normal; font-weight:400; font-display:swap; }
    @font-face { font-family:"Antonio LCARS"; src:url("${CARD_BASE_URL}fonts/antonio-600.ttf") format("truetype"); font-style:normal; font-weight:600; font-display:swap; }
    @font-face { font-family:"Antonio LCARS"; src:url("${CARD_BASE_URL}fonts/antonio-700.ttf") format("truetype"); font-style:normal; font-weight:700; font-display:swap; }
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-dashboard { --lcars-font:"Antonio LCARS","Arial Narrow",sans-serif; min-height:var(--map-height,680px); padding:18px; color:#f5f1ff; background:#050507; font-family:var(--lcars-font); }
    ...
    .lcars-title strong { font-family:var(--lcars-font); font-size:26px; font-weight:400; letter-spacing:.025em; line-height:1; text-transform:uppercase; }
    .lcars-clock,.lcars-date { display:flex; align-items:center; justify-content:flex-end; padding:10px 8px; color:var(--lcars-datetime,#ff9900); background:#050507; font-family:var(--lcars-font); font-size:27px; font-weight:400; letter-spacing:.025em; line-height:1; white-space:nowrap; }
    ...
    .lcars-floor-nav button span { justify-content:center; border-radius:28px 0 0 28px; font-family:var(--lcars-font); font-size:29px; font-weight:400; letter-spacing:.02em; }
    .lcars-floor-nav button b { padding:0 11px; overflow:hidden; font-family:var(--lcars-font); font-size:15px; font-weight:400; letter-spacing:.025em; line-height:1; text-overflow:ellipsis; text-transform:uppercase; white-space:nowrap; }
    ...
    .lcars-floor>header button { display:flex; align-items:center; gap:8px; padding:7px 15px; border:0; border-radius:25px 0 0 0; color:var(--lcars-tone-contrast); background:var(--lcars-tone); font-family:var(--lcars-font); font-size:20px; line-height:1.2; font-weight:400; letter-spacing:.025em; text-transform:uppercase; cursor:pointer; }
    ...
    .lcars-floor>header b { align-self:end; min-width:115px; padding:7px 16px; border-radius:20px 20px 0 0; color:var(--lcars-tone-contrast); background:var(--lcars-tone); font-family:var(--lcars-font); font-size:22px; font-weight:400; letter-spacing:.035em; line-height:1; text-align:right; }
    ...
    .lcars-device-name { min-width:0; min-height:42px; display:flex; align-items:center; gap:9px; padding:10px 13px; border:0; border-radius:20px 0 0 20px; color:var(--lcars-device-contrast); background:var(--lcars-device); font-family:var(--lcars-font); font-size:16px; font-weight:400; letter-spacing:.02em; text-align:left; cursor:pointer; }
    ...
    .lcars-bridge { --bridge-rail:94px; --bridge-gap:16px; color:#f5f1ff; background:#050507; }.lcars-bridge>header { position:relative; min-height:64px; display:flex; align-items:center; gap:22px; padding:0 24px 0 calc(var(--bridge-rail) + var(--bridge-gap) + 24px); overflow:hidden; border-radius:34px 34px 0 0; color:#08080a; background:var(--bridge-tone); font-family:var(--lcars-font); font-size:19px; letter-spacing:.045em; text-transform:uppercase; }.lcars-bridge>header::before { content:""; position:absolute; top:0; bottom:0; left:var(--bridge-rail); width:var(--bridge-gap); background:#050507; }.lcars-bridge>header strong { margin-right:auto; font-size:31px; font-weight:600; }.lcars-bridge>header span { white-space:nowrap; }.lcars-bridge>header span:nth-of-type(2) { color:#aaaaff; }.lcars-bridge>header span:nth-of-type(3) { color:#4d4b51; }.lcars-bridge>header i { width:9px; height:9px; border-radius:50%; background:#050507; }.lcars-bridge>header b { margin-left:auto; color:#ff9900; font-size:27px; font-weight:600; }
    .lcars-bridge-shell { display:grid; grid-template-columns:var(--bridge-rail) minmax(0,1fr); gap:var(--bridge-gap); }.lcars-bridge-shell>aside { display:grid; grid-template-rows:58px minmax(140px,1fr) 96px minmax(140px,1fr) 58px; gap:8px; align-items:center; justify-items:center; min-height:780px; color:#08080a; background:#050507; font-family:var(--lcars-font); letter-spacing:.04em; }.lcars-bridge-shell>aside i { width:100%; height:100%; background:#162b33; }.lcars-bridge-shell>aside b { width:100%; height:100%; display:grid; place-items:center; box-sizing:border-box; background:var(--bridge-tone); font-size:14px; font-weight:600; }.lcars-bridge-shell>aside b:nth-of-type(2) { color:#08080a; background:#9999ff; }.lcars-bridge-shell>aside b:first-child { border-radius:0 0 24px 0; }.lcars-bridge-shell>aside b:last-child { border-radius:0 24px 0 0; }
    .lcars-bridge-grid { position:relative; min-width:0; display:grid; grid-template-columns:minmax(420px,1fr) minmax(420px,1fr); gap:28px; padding:16px 0 14px; }.lcars-bridge-primary,.lcars-bridge-secondary { position:relative; min-width:0; }.lcars-bridge-secondary { display:flex; flex-direction:column; gap:16px; }.lcars-bridge-camera-wrap { position:relative; }.lcars-bridge-camera-wrap::before { content:""; position:absolute; z-index:0; top:-16px; left:28%; width:7px; height:16px; background:var(--bridge-tone); }.lcars-bridge-camera-wrap::after { content:""; position:absolute; z-index:0; top:27px; left:-28px; width:28px; height:7px; background:var(--bridge-tone); }.lcars-bridge-camera-wrap>.lcars-bridge-camera { position:relative; z-index:1; }.lcars-bridge .lcars-area { --lcars-area-tone:var(--bridge-tone); --lcars-area-contrast:var(--bridge-contrast); border:6px solid var(--bridge-tone); border-radius:30px; background:#050507; }.lcars-bridge .lcars-area>header { height:62px; padding:0; border-radius:24px 24px 0 0; background:#050507; }.lcars-bridge .lcars-area>header>button[data-area-config] { padding-left:24px; color:var(--bridge-tone); }.lcars-bridge .lcars-area>header strong { color:var(--bridge-tone); font-size:24px; }.lcars-bridge .lcars-area-reading { margin-right:14px; }.lcars-bridge .lcars-devices { padding:8px 8px 14px 12px; }.lcars-bridge .lcars-device { gap:7px; padding-top:7px; padding-bottom:7px; }.lcars-bridge .lcars-device-name { min-height:48px; border-radius:24px 0 0 24px; text-transform:uppercase; }.lcars-bridge .lcars-meter,.lcars-bridge .lcars-standby { min-height:48px; border-radius:0 24px 24px 0; }.lcars-bridge .lcars-standby { color:#08080a; background:#9999ff; }
    .lcars-bridge .lcars-standby.offline { color:#f5f1ff; background:#555962; text-shadow:0 1px 2px #000; }.bridge-active .lcars-footer { grid-template-columns:minmax(0,1fr) auto 92px; gap:12px; margin:0; }.bridge-active .lcars-footer span { position:relative; height:42px; margin-left:110px; background:var(--lcars-footer-tone); }.bridge-active .lcars-footer span::before { content:""; position:absolute; top:0; bottom:0; left:-110px; width:94px; border-radius:0 0 0 30px; background:var(--lcars-footer-tone); }.bridge-active .lcars-footer b { color:#d9d2e9; font-family:var(--lcars-font); font-size:11px; font-weight:600; }.bridge-active .lcars-footer i { height:42px; border-radius:0 24px 24px 0; }
    .lcars-bridge-camera { overflow:hidden; border:6px solid var(--bridge-tone); border-radius:30px; background:#050507; }.lcars-bridge-camera>header { display:grid; grid-template-columns:25px 1fr auto; align-items:center; gap:9px; min-height:58px; padding:0 18px; color:var(--bridge-tone); background:#050507; font-family:var(--lcars-font); font-size:24px; letter-spacing:.04em; text-transform:uppercase; }.lcars-bridge-camera>header strong,.lcars-bridge-camera>header b { font-weight:400; }.lcars-bridge-camera>header b { color:#d9d2e9; font-size:16px; }.lcars-bridge-feed { position:relative; }.lcars-bridge-feed .lcars-camera-card { min-height:310px; }.lcars-bridge-feed>i { position:absolute; width:28px; height:28px; border-color:var(--bridge-tone); border-style:solid; pointer-events:none; }.lcars-bridge-feed>i:nth-of-type(1) { top:12px; left:12px; border-width:3px 0 0 3px; }.lcars-bridge-feed>i:nth-of-type(2) { top:12px; right:12px; border-width:3px 3px 0 0; }.lcars-bridge-feed>i:nth-of-type(3) { bottom:12px; left:12px; border-width:0 0 3px 3px; }.lcars-bridge-feed>i:nth-of-type(4) { right:12px; bottom:12px; border-width:0 3px 3px 0; }.lcars-bridge-camera>footer { display:grid; grid-template-columns:repeat(4,1fr); gap:3px; padding:5px; background:var(--bridge-tone); }.lcars-bridge-camera>footer span { min-width:0; padding:9px 5px; overflow:hidden; color:#d9d2e9; background:#0b0b10; font-family:var(--lcars-font); font-size:12px; letter-spacing:.03em; text-align:center; text-overflow:ellipsis; white-space:nowrap; }
    ...
    .lcars-popup-top { display:grid; grid-template-columns:1fr auto 54px; align-items:center; height:48px; color:#fff; background:#9999ff; font-family:var(--lcars-font); font-size:18px; letter-spacing:.04em; }
