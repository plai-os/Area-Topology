const CARD_VERSION = "1.27.31";
const BUILD_COMMIT = "33e6c78";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-weather-current dl { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; }.lcars-weather-current dl>div { min-width:0; margin-top:0; }.lcars-weather-current dt { font-size:22px; }.lcars-weather-current dd { font-size:23px; }.lcars-weather-current dt ha-icon { --mdc-icon-size:22px; }.lcars-weather-current dd { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
