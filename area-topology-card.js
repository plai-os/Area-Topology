const CARD_VERSION = "1.25.19";
const BUILD_COMMIT = "17c53cb";
...
class AreaTopologyCard extends HTMLElement {
  ...
  renderLcarsBridge(config, group, securityConfig, color) {
    ...
    return `<section class="lcars-bridge" style="--bridge-tone:${color};--bridge-contrast:${contrastColor(color)};--lcars-area-tone:${color};--lcars-area-contrast:${contrastColor(color)}">
      ...
      <div class="lcars-bridge-shell">
        <aside><b>MJ-32</b><i></i><b>DATA NODE</b><i></i><b>MJ-32</b></aside>
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge { --bridge-gap:23px; }
    .lcars-bridge>header::before { left:calc(var(--bridge-rail) + 28px); width:calc(var(--bridge-title-gap) - 28px); }
    .lcars-bridge-shell>aside b:first-child,.lcars-bridge-shell>aside b:last-child { position:relative; z-index:2; border-radius:0; }
    .lcars-bridge-shell>aside b:first-child::before { content:""; position:absolute; top:0; left:100%; width:28px; height:28px; background:radial-gradient(circle 28px at 100% 100%,#050507 0 27px,var(--bridge-tone) 28px); }
    .lcars-bridge-shell>aside b:last-child::before { content:""; position:absolute; bottom:0; left:100%; width:28px; height:28px; background:radial-gradient(circle 28px at 100% 0,#050507 0 27px,var(--bridge-tone) 28px); }
    .lcars-bridge-grid { padding-top:var(--bridge-gap); padding-bottom:var(--bridge-gap); }
    .bridge-active .lcars-footer span { margin-left:134px; }
    .bridge-active .lcars-footer span::before { left:-134px; width:122px; }
