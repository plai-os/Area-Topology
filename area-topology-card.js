const CARD_VERSION = "1.25.5";
const BUILD_COMMIT = "06d6dbb";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-floor-nav button b { padding:2px 10px 0; overflow:hidden; font-family:var(--lcars-font); font-size:27px; font-weight:400; letter-spacing:.01em; line-height:1; text-overflow:ellipsis; text-transform:uppercase; white-space:nowrap; }
