const CARD_VERSION = "1.27.28";
const BUILD_COMMIT = "21ae388";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-meter,.lcars-meter span,.lcars-standby { font-size:18px!important; }.lcars-meter b { font-size:19px!important; }.lcars-area-reading b { font-size:16px!important; }.lcars-bridge-camera>footer span,.lcars-bridge-camera>footer b { font-size:19px!important; }.tree-property b,.tree-property em { font-size:calc(var(--tree-property,12px) * 1.15)!important; }.lcars-bridge .lcars-meter,.lcars-bridge .lcars-meter span,.lcars-bridge .lcars-standby { font-size:20px!important; }.lcars-bridge .lcars-meter b { font-size:21px!important; }
