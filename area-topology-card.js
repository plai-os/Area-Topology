const CARD_VERSION = "1.25.13";
const BUILD_COMMIT = "e993818";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge-shell>aside b:first-child::before { content:""; position:absolute; top:0; left:100%; width:28px; height:36px; background:radial-gradient(circle at 0 0,var(--bridge-tone) 0 35px,#050507 36px); }
