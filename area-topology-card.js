const CARD_VERSION = "1.25.4";
const BUILD_COMMIT = "253a0be";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-floor-nav button span { justify-content:center; padding-top:2px; border-radius:28px 0 0 28px; font-family:var(--lcars-font); font-size:31px; font-weight:400; letter-spacing:.015em; line-height:1; }
    .lcars-floor-nav button b { padding:2px 12px 0; overflow:hidden; font-family:var(--lcars-font); font-size:21px; font-weight:400; letter-spacing:.015em; line-height:1; text-overflow:ellipsis; text-transform:uppercase; white-space:nowrap; }
