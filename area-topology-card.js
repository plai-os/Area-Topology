const CARD_VERSION = "1.27.22";
const BUILD_COMMIT = "ed1d4eb";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge-shell>aside b:first-child,.lcars-bridge-shell>aside b:last-child { position:relative; z-index:2; overflow:hidden; border-radius:0; color:#fff; text-shadow:0 1px 2px rgba(0,0,0,.7); }
    .lcars-bridge-shell>aside b:first-child::before { content:""; position:absolute; right:0; bottom:0; width:36px; height:36px; border-radius:36px 0 0 0; background:#050507; }
    .lcars-bridge-shell>aside b:last-child::before { content:""; position:absolute; top:0; right:0; width:36px; height:36px; border-radius:0 0 0 36px; background:#050507; }
