...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    @font-face { font-family:"Teko LCARS"; src:url("${CARD_BASE_URL}fonts/teko-400.ttf") format("truetype"); font-style:normal; font-weight:400; font-display:swap; }
    @font-face { font-family:"Teko LCARS"; src:url("${CARD_BASE_URL}fonts/teko-500.ttf") format("truetype"); font-style:normal; font-weight:500; font-display:swap; }
    @font-face { font-family:"Teko LCARS"; src:url("${CARD_BASE_URL}fonts/teko-600.ttf") format("truetype"); font-style:normal; font-weight:600; font-display:swap; }
    @font-face { font-family:"Teko LCARS"; src:url("${CARD_BASE_URL}fonts/teko-700.ttf") format("truetype"); font-style:normal; font-weight:700; font-display:swap; }
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-dashboard { --lcars-font:"Teko LCARS","Arial Narrow",sans-serif; min-height:var(--map-height,680px); padding:18px; color:#f5f1ff; background:#050507; font-family:var(--lcars-font); }
    ...
    .lcars-bridge { --bridge-rail:94px; --bridge-gap:16px; --bridge-title-gap:8px; color:#f5f1ff; background:#050507; }.lcars-bridge>header { position:relative; min-height:68px; display:flex; align-items:center; gap:22px; padding:0 24px 0 calc(var(--bridge-rail) + var(--bridge-title-gap) + 24px); overflow:hidden; border-radius:36px 36px 0 0; color:#08080a; background:var(--bridge-tone); font-family:var(--lcars-font); font-size:24px; font-weight:500; line-height:1; letter-spacing:.025em; text-transform:uppercase; }.lcars-bridge>header::before { content:""; position:absolute; top:0; bottom:0; left:var(--bridge-rail); width:var(--bridge-title-gap); background:#050507; }.lcars-bridge>header strong { margin-right:auto; font-size:40px; font-weight:600; line-height:1; }.lcars-bridge>header span { white-space:nowrap; }.lcars-bridge>header span:nth-of-type(2) { color:#aaaaff; }.lcars-bridge>header span:nth-of-type(3) { color:#4d4b51; }.lcars-bridge>header i { width:9px; height:9px; border-radius:50%; background:#050507; }.lcars-bridge>header b { margin-left:auto; color:#ff9900; font-size:36px; font-weight:600; line-height:1; }
    .lcars-bridge-shell { display:grid; grid-template-columns:var(--bridge-rail) minmax(0,1fr); gap:var(--bridge-gap); }.lcars-bridge-shell>aside { display:grid; grid-template-rows:58px minmax(140px,1fr) 96px minmax(140px,1fr) 58px; gap:8px; align-items:center; justify-items:center; min-height:780px; color:#08080a; background:#050507; font-family:var(--lcars-font); letter-spacing:.02em; }.lcars-bridge-shell>aside i { width:100%; height:100%; background:#162b33; }.lcars-bridge-shell>aside b { width:100%; height:100%; display:grid; place-items:center; box-sizing:border-box; background:var(--bridge-tone); font-size:20px; font-weight:600; line-height:1; }.lcars-bridge-shell>aside b:nth-of-type(2) { color:#08080a; background:#9999ff; }.lcars-bridge-shell>aside b:first-child { border-radius:0 0 30px 0; }.lcars-bridge-shell>aside b:last-child { border-radius:0 30px 0 0; }
