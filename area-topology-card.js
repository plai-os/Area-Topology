const CARD_VERSION = "1.27.5";
const BUILD_COMMIT = "03f046f";
...
class AreaTopologyCard extends HTMLElement {
  ...
  renderLcarsFromViews() {
    ...
    return `<div class="lcars-dashboard lcars-kiosk bridge-active" style="--lcars-header:${headerColor};--lcars-header-contrast:${contrastColor(headerColor)};--lcars-datetime:${dateTimeColor};--lcars-kiosk-height:${kioskHeight}">
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-kiosk .lcars-floor-nav { min-height:0; height:100%; overflow:hidden; }
