const CARD_VERSION = "1.25.17";
const BUILD_COMMIT = "35af816";
...
class AreaTopologyCard extends HTMLElement {
  ...
  styles() { return `
    ...
    * { box-sizing:border-box; }
    ...
    .lcars-bridge { --bridge-gap:28px; }
    .lcars-bridge>header::before { left:calc(var(--bridge-rail) + 28px); width:calc(var(--bridge-title-gap) - 28px); }
    .lcars-bridge-shell>aside b:first-child { position:relative; z-index:2; border-radius:0; }
    ...
    .lcars-bridge-grid { padding-top:var(--bridge-gap); }
